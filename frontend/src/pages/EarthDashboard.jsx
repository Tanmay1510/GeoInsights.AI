...
const COMMON_QUESTIONS = [
    ...
    "Are there any tree plantation drives happening nearby?",
    "What industrial activities are present in this ward?",
            ...
            <div className="max-w-7xl mx-auto px-4 py-4 space-y-4">
                ...
                {selectedRole && (
                    <div className="rounded-2xl border border-white/10 bg-gray-900/60 overflow-hidden">
                        <div className="p-3 flex items-center gap-2 bg-gray-900/60">
                            ...
                            <span className="text-xs text-gray-300">Click anywhere on the map to get coordinates</span>
                        </div>
                ...
                {selectedRole && (
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        {/* Ward Selection */}
                        <div className="rounded-2xl border border-white/10 bg-gray-900/60 p-4">
                            <div className="font-semibold mb-3">Or Select a Ward</div>
